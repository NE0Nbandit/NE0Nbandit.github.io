...
window.addEventListener('DOMContentLoaded', () => {
  const MIKE_CONFIG = {    
    ...
    ORIGINAL_ACTIONS: ['walk', 'walk','walk','walk','walk','walk','spin','spin','spin','dance2','dance2', 'dance2','dance2', 'dance2','dance2', 'dance2','dance2','sit','sit','dance','dance', 'dance','dance', 'dance','dance', 'dance','dance', 'nap','nap','trip']
  };
  ...
  const creatures = [];  
  creatures.push(new Creature('webmeji-2', MIKE_CONFIG));
